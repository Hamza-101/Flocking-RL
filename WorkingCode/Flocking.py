...
model = PPO("MlpPolicy", env, tensorboard_log="./ppo_Agents_tensorboard/", verbose=1, n_steps=20000)
...
for episode in range(1, RLVariables['Episodes']):
    ...
    with open(rf'FlockingCustom{episode}.json', 'w') as f:        #Add to params file
