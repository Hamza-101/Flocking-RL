...
class FlockingEnv(gym.Env):
    ...
    def calculate_reward(self):
        ...
        for _, agent in enumerate(self.agents): 
            ...
            reward=self.calculate_total(agent, neighbor_positions)
            ...
            val = 0.3*(reward) + 0.7*(AlignmentReward)
        return val 
    ...
    def calculate_total(self, agent, neighbor_positions):
        reward = 0
    ...
    def read_agent_locations(self):
        File = rf"{Results['InitPositions']}" + "5" + "\config.json"
        # print(File)
