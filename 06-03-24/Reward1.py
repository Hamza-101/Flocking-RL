...
class FlockingEnv(gym.Env):
    ...
    def calculate_reward(self):
        ...
        for _, agent in enumerate(self.agents): 
            ...
            reward, out_of_flock=self.calculate_combined_reward(agent, neighbor_velocities)      
    ...
    # CTDE
    def calculate_combined_reward(self, agent, neighbor_velocities):
        out_of_flock=False
        total_reward=0
        ...
        if (len(neighbor_velocities) > 0):
                ...
                total_reward =  100 * multiplier * (1 - np.abs(orientation_diff))
        ...
        #     total_reward = 1 - np.abs(orientation_diff)
