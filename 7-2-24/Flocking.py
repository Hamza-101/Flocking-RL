...
class FlockingEnv(gym.Env):
    ...
    def step(self, actions):
        ...
        # print("AlignmentReward", alignment_reward)
        # print("CohesionReward", cohesion_reward)
        # print("SeparationReward", separation_reward)
        # print("CollisionReward", collision_reward)
        # print("Reward", reward)
...
for episode in range(0, SimulationVariables['Episodes']):
    ...
    agent_positions = {i: {'positions': [], 'velocities': [], 'accelerations': []} for i in range(len(env.agents))}
    ...
    #     velocities_data = [{i, data['velocities']} for i, data in agent_positions.items()]
    #     json.dump(velocities_data, f, indent=4)

    # with open(rf"{accelerations_directory}Episode_{episode}.json", 'w') as f:
    #     accelerations_data = [{i, data['accelerations']} for i, data in agent_positions.items()]
