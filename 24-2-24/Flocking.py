...
class FlockingEnv(gym.Env):
    ...
    def step(self, actions):
        ...
        #alignment_reward, cohesion_reward, separation_reward, collision_reward, Collisions
    ...
    def calculate_reward(self):
        ...
        for _, agent in enumerate(self.agents): 
            ...
            reward=self.calculate_combined_reward(agent, neighbor_positions, neighbor_velocities) #############################################################
...
policy_kwargs = dict(
    ...
    net_arch=[
        ...
        dict(pi=[256, 256, 256, 256, 256, 256, 256, 256], vf=[256, 256, 256, 256, 256, 256, 256, 256]),
    ]
)
